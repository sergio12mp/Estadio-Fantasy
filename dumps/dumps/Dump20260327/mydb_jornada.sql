...
CREATE TABLE `jornada` (
  ...
  KEY `idx_Jornada_idTemporada` (`idTemporada`),
  CONSTRAINT `fk_Jornada_Temporada` FOREIGN KEY (`idTemporada`) REFERENCES `temporada` (`idTemporada`)
...
-- Dump completed on 2026-03-27 14:15:58
