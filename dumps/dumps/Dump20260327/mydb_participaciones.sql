...
CREATE TABLE `participaciones` (
  ...
  KEY `idx_Participaciones_idLigas` (`idLigas`),
  KEY `idx_Participaciones_idManager` (`idManager`),
  CONSTRAINT `fk_Participaciones_Manager` FOREIGN KEY (`idManager`) REFERENCES `manager` (`idManager`)
