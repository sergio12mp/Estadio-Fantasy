...
-- Schema railway
-- -----------------------------------------------------
-- CREATE SCHEMA IF NOT EXISTS `railway` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `railway`;

-- -----------------------------------------------------
-- Table `railway`.`Equipo`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `railway`.`Equipo`;

CREATE TABLE IF NOT EXISTS `railway`.`Equipo` (
...
-- -----------------------------------------------------
-- Table `railway`.`Jugador`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `railway`.`Jugador`;

CREATE TABLE IF NOT EXISTS `railway`.`Jugador` (
  ...
  CONSTRAINT `fk_Jugador_Equipo`
    ...
    REFERENCES `railway`.`Equipo` (`idEquipo`)
    ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `railway`.`Temporada`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `railway`.`Temporada`;

CREATE TABLE IF NOT EXISTS `railway`.`Temporada` (
...
-- -----------------------------------------------------
-- Table `railway`.`Jornada`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `railway`.`Jornada`;

CREATE TABLE IF NOT EXISTS `railway`.`Jornada` (
  ...
  CONSTRAINT `fk_Jornada_Temporada`
    ...
    REFERENCES `railway`.`Temporada` (`idTemporada`)
    ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `railway`.`Partido`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `railway`.`Partido`;

CREATE TABLE IF NOT EXISTS `railway`.`Partido` (
  ...
  CONSTRAINT `fk_Partido_Jornada`
    ...
    REFERENCES `railway`.`Jornada` (`idJornada`)
    ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `railway`.`Estadisticas`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `railway`.`Estadisticas`;

CREATE TABLE IF NOT EXISTS `railway`.`Estadisticas` (
  ...
  CONSTRAINT `fk_Estadisticas_Partido`
    ...
    REFERENCES `railway`.`Partido` (`idPartido`, `idJornada`)
    ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Estadisticas_JugadorEquipo`
    FOREIGN KEY (`idJugador`, `idEquipo`)
    REFERENCES `railway`.`Jugador` (`idJugador`, `idEquipo`)
    ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `railway`.`Manager`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `railway`.`Plantilla`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `railway`.`Plantilla`;

CREATE TABLE IF NOT EXISTS `railway`.`Plantilla` (
  ...
  CONSTRAINT `fk_Plantilla_Manager`
    ...
    REFERENCES `railway`.`Manager` (`idManager`)
    ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `railway`.`Objetos`
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `railway`.`Objetos`;

CREATE TABLE IF NOT EXISTS `railway`.`Objetos` (
...
-- Table `railway`.`Ligas`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `railway`.`Ligas`;

CREATE TABLE IF NOT EXISTS `railway`.`Ligas` (
...
-- -----------------------------------------------------
-- Table `railway`.`Manager_Ligas`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `railway`.`Manager_Ligas`;

CREATE TABLE IF NOT EXISTS `railway`.`Manager_Ligas` (
  ...
  CONSTRAINT `fk_ML_Ligas`
    ...
    REFERENCES `railway`.`Ligas` (`idLigas`)
    ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `railway`.`CartaObjeto`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `railway`.`CartaObjeto`;

CREATE TABLE IF NOT EXISTS `railway`.`CartaObjeto` (
  ...
  CONSTRAINT `fk_CartaObjeto_Objetos`
    ...
    REFERENCES `railway`.`Objetos` (`idObjetos`)
    ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `railway`.`CartaJugador`
-- CORRECCIÓN: Se añade columna Rareza (requerida por sobres, álbum y registro)
-- -----------------------------------------------------
DROP TABLE IF EXISTS `railway`.`CartaJugador`;

CREATE TABLE IF NOT EXISTS `railway`.`CartaJugador` (
  ...
  CONSTRAINT `fk_CartaJugador_Jugador`
    ...
    REFERENCES `railway`.`Jugador` (`idJugador`)
    ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `railway`.`PlantillaJugadorObjeto`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `railway`.`PlantillaJugadorObjeto`;

CREATE TABLE IF NOT EXISTS `railway`.`PlantillaJugadorObjeto` (
  ...
  CONSTRAINT `fk_PJO_Plantilla`
    ...
    REFERENCES `railway`.`Plantilla` (`idPlantilla`)
    ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_PJO_CartaObjeto`
    FOREIGN KEY (`idCartaObjeto`)
    REFERENCES `railway`.`CartaObjeto` (`idCartaObjeto`)
    ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_PJO_CartaJugador`
    FOREIGN KEY (`idCartaJugador`)
    REFERENCES `railway`.`CartaJugador` (`idCartaJugador`)
    ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB;
...
-- Temporada actual
INSERT INTO `railway`.`Temporada` (`Nombre`) VALUES ('LaLiga 2024-25');

-- Jornadas (38 jornadas de LaLiga)
INSERT INTO `railway`.`Jornada` (`Nombre`, `idTemporada`) VALUES
...
INSERT INTO `railway`.`Equipo` (`Nombre`) VALUES
  ('Real Madrid'),        -- 1
  ('FC Barcelona'),       -- 2
...
INSERT INTO `railway`.`Ligas` (`Nombre`, `Codigo`, `tipo`) VALUES ('Liga General', NULL, 'general');


-- -----------------------------------------------------
-- Table `railway`.`Config`
-- Almacena pares clave-valor para configuración global
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `railway`.`Config` (
...
INSERT INTO `railway`.`Config` (`clave`, `valor`)
